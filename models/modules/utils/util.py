...
from models.modules.utils.nms import nms_locality
from models.modules.utils.converter import keys
from models.modules.utils.converter import StringLabelConverter
...
def show_box(image, box, transcirpt):
    ...
    img = cv2.putText(img, transcirpt, (origin[0], origin[1]+20), font, 1, (0, 0, 0), 2)
